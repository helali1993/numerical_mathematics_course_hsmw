...
%% Stable with Fixed Points

clear all;

% Initialization Parameters
% rho < 24.74 (Stable with fixed points)
sigma = 10;
beta = 8/3;
rho = 12;
...
% We plot our results
figure('Name','Example 2: Stable and Fixed Points','NumberTitle','off')
plot3(x,y, z, "g");
...
% Plotting the results from the builtin function
figure('Name','Builtin Example 2: Stable and Fixed Points','NumberTitle','off')
plot3(xyz(:,1),xyz(:,2),xyz(:,3), "b")

% Plotting the results of our implementation aganist
% the builtin fucntion.
figure('Name','Compare with Builtin: Stable and Fixed Points','NumberTitle','off')
plot3(x,y, z, "g", xyz(:,1),xyz(:,2),xyz(:,3), "b");
disp_leg = legend;
disp_leg.String{1} = "Implementation";
disp_leg.String{2} = "Builtin";
